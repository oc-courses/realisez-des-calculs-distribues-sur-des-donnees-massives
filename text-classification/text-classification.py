...
train_data = load_dataframe(os.path.join(os.path.dirname(__file__), "20ng-train-all-terms.txt")).persist()
test_data = load_dataframe(os.path.join(os.path.dirname(__file__), "20ng-test-all-terms.txt")).persist()
